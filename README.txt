...
This is the readme for invade, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Invade) > Ok.
...
- To run the project find Invade.java (which will be in under src/main/java/berlin/ong/student) and right click > Run 'Invade'
